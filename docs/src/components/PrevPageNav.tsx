...
const PrevPageNav = (props: PrevPageNavProps) => {
    ...
    return (
        <Link to={href} className="card group flex items-center justify-self-start bg-blue-50 border border-blue-200 inset-ring active:inset-ring-2 inset-ring-base-background hover:border-blue-300 hover:bg-blue-100 active:border-blue-400 active:bg-blue-200 w-72 transition-all">
