    ...
    <div class="form-field-inline">
        ...
        <input type="email" class="input" placeholder="Email">
                ...
                <div className="alert alert-outline mb-4">
                    ...
                    <span>Responsive breakpoints can be used with <code className="tag">form-field-inline</code> class to enable responsive layout.</span>
                </div>

                <Preview code={`<form class="form">
    <div class="form-field sm:form-field-inline">
        <label class="label">Your email</label>
        <input type="email" class="input" placeholder="Email">
    </div>
</form>`}/>
