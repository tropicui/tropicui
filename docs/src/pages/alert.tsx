    ...
    return (
        <>
            <div className="pt-8">
                ...
                <h6>The <strong>Alert</strong> component displays important messages and notifications to users with various styling options.</h6>
...
<div class="alert alert-outline alert-success">
    ...
    <span>Your password has been successfully updated! You can now continue to <a class="btn btn-link btn-accent">your account</a>.</span>
</div>
<div class="alert alert-soft alert-warning">
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
...
<div class="alert alert-danger">
    ...
    <span>Your password reset failed! Please try again or <a class="btn btn-link text-danger-content">contact support</a>.</span>
</div>`}>
                    <div className="alert">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75 11.25 15 15 9.75m-3-7.036A11.959 11.959 0 0 1 3.598 6 11.99 11.99 0 0 0 3 9.749c0 5.592 3.824 10.29 9 11.623 5.176-1.332 9-6.03 9-11.622 0-1.31-.21-2.571-.598-3.751h-.152c-3.196 0-6.1-1.248-8.25-3.285Z" />
                    ...
                    <div className="alert alert-outline alert-success">
                        ...
                        <span>Your password has been successfully updated! You can now continue to <a className="btn btn-link btn-accent">your account</a>.</span>
                    </div>
                    <div className="alert alert-soft alert-warning">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3.75m-9.303 3.376c-.866 1.5.217 3.374 1.948 3.374h14.71c1.73 0 2.813-1.874 1.948-3.374L13.949 3.378c-.866-1.5-3.032-1.5-3.898 0L2.697 16.126ZM12 15.75h.007v.008H12v-.008Z" />
                    ...
                    <div className="alert alert-danger">
                        ...
                        <span>Your password reset failed! Please try again or <a className="btn btn-link text-danger-content">contact support</a>.</span>
                    </div>
                </Preview>
...
<div class="alert alert-outline alert-success">
    <span>Your password has been successfully updated! You can now continue to <a class="btn btn-link btn-accent">your account</a>.</span>
    <input type="radio" class="alert-close btn btn-clear btn-round btn-icon btn-success"></input>
</div>
<div class="alert alert-soft alert-warning">
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
        <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3.75m-9.303 3.376c-.866 1.5.217 3.374 1.948 3.374h14.71c1.73 0 2.813-1.874 1.948-3.374L13.949 3.378c-.866-1.5-3.032-1.5-3.898 0L2.697 16.126ZM12 15.75h.007v.008H12v-.008Z" />
    ...
    <span>Your password has expired! Please reset your password from your <a class="btn btn-link btn-accent">account here</a>.</span>
    <input type="radio" class="alert-close btn btn-clear btn-round btn-icon btn-warning"></input>
</div>
<div class="alert alert-danger">
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
        <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3.75m9-.75a9 9 0 1 1-18 0 9 9 0 0 1 18 0Zm-9 3.75h.008v.008H12v-.008Z" />
    ...
    <span>Your password reset failed! Please try again or <a class="btn btn-link text-danger-content">contact support</a>.</span>
    <input type="radio" class="alert-close btn btn-clear btn-round btn-icon btn-danger"></input>
</div>`}>
                    <div className="alert">
                        <span>Your account has been restored! You can now continue to <a className="btn btn-link btn-accent">your account</a>.</span>
                    ...
                    <div className="alert alert-outline alert-success">
                        <span>Your password has been successfully updated! You can now continue to <a className="btn btn-link btn-accent">your account</a>.</span>
                        <input type="radio" className="alert-close btn btn-clear btn-round btn-icon btn-success"></input>
                    </div>
                    <div className="alert alert-soft alert-warning">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3.75m-9.303 3.376c-.866 1.5.217 3.374 1.948 3.374h14.71c1.73 0 2.813-1.874 1.948-3.374L13.949 3.378c-.866-1.5-3.032-1.5-3.898 0L2.697 16.126ZM12 15.75h.007v.008H12v-.008Z" />
                        ...
                        <span>Your password has expired! Please reset your password from your <a className="btn btn-link btn-accent">account here</a>.</span>
                        <input type="radio" className="alert-close btn btn-clear btn-round btn-icon btn-warning"></input>
                    </div>
                    <div className="alert alert-danger">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3.75m9-.75a9 9 0 1 1-18 0 9 9 0 0 1 18 0Zm-9 3.75h.008v.008H12v-.008Z" />
                        ...
                        <span>Your password reset failed! Please try again or <a className="btn btn-link text-danger-content">contact support</a>.</span>
                        <input type="radio" className="alert-close btn btn-clear btn-round btn-icon btn-danger"></input>
                    </div>
                </Preview>
