...
function Badge() {
        ...
        <>
            <div className="pt-8">
                ...
                <div className="alert alert-outline mb-4">
                    ...
                    <span>This preview uses the <Link to="/components/tag" className="btn btn-link btn-accent">Tag</Link> component for the indicator.</span>
                </div>
    ...
    <button class="btn">Messages</button>
                ...
                <div className="alert alert-outline mb-4">
                    ...
                    <span>This preview uses the <Link to="/components/status" className="btn btn-link btn-accent">Status</Link> component for the indicator.</span>
                </div>
