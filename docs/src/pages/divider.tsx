    ...
    return (
        <>
            <div className="pt-8">
                ...
                <Preview code={`<div class="divider"></div>`}/>

                <h4 id="spacing">Spacing</h4>

                <p>Spacing such as top & bottom margin <code className="tag">my-4</code> is commonly used on divider to space content around it.</p>

                <Preview code={`<div>
    <h3 class="text-muted">Content Above</h3>
</div>

<div class="divider my-4"></div>

<div>
    <h3 class="text-muted">Content Below</h3>
</div>`}/>
...
<div class="divider divider-end-xl">End Extra Large</div>`}/>
    ...
    <span class="text-end text-muted">Content Left</span>
    ...
    <span class="text-muted">Content Right</span>
                ...
                <Preview code={`<div class="flex items-center gap-4 h-64">
    <div>
